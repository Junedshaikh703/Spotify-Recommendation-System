...
# set paths
# output paths
track_ids_save_path = "data/transformed/track_ids.npy"
filtered_data_save_path = "data/cleaned/collab_filtered_data.csv"
interaction_matrix_save_path = "data/transformed/interaction_matrix.npz"
# input paths
